...
func QueryFunction(fname string) func(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response {
	QueryFunc := map[string]func(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response{
		...
		"qIsItemOnAuction":       IsItemOnAuction,
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
func IsItemOnAuction(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response {
	if len(args) < 2 {
		fmt.Println("IsItemOnAuction() : Requires 2 arguments Item#, RecordType")
		jsonResp := "{\"Error\":\"IsItemOnAuction() : Requires 2 arguments Item#, RecordType " + "\"}"
